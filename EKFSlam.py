...
def calculate_odo(input_matrix, emat, read_data, observations, data_list):
    global et, mut
    ...
    et = emat
    mut = input_matrix
    mutu_matrix = get_mutu(input_matrix, odom)
    etu_matrix = get_etu(input_matrix, observations[0])
    result = get_result_matrix(input_matrix, odom) #motion model
    return calculate_observation(mutu_matrix, etu_matrix, result, observations, data_list)


# def get_result_matrix1(input_matrix, sensor_data):
...
def get_result_matrix(input_matrix, odom):
    result_matrix = [[0] for j in range(3)]
    result_matrix[0][0] = input_matrix[0][0] + odom[0] * math.cos(input_matrix[2][0] + odom[1])
    result_matrix[1][0] = input_matrix[1][0] + odom[0] * math.sin(input_matrix[2][0] + odom[1])
    result_matrix[2][0] = input_matrix[2][0] + odom[1] 
    return result_matrix
